...
api_router.include_router(llms.router, prefix="/llms", tags=["LLM 模型"])
api_router.include_router(apikeys.router, prefix="/apikeys", tags=["API 密钥"])
...
api_router.include_router(robot_skills.router, prefix="/robots", tags=["机器人技能绑定"])
